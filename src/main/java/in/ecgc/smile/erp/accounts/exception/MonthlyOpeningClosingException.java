...
public class MonthlyOpeningClosingException extends RuntimeException {
...
private Object[] args; 
	...
	public MonthlyOpeningClosingException() {
		super();
	}
	
	public MonthlyOpeningClosingException(String message) {
		super(message);
	}
	
	public MonthlyOpeningClosingException(String message, Object[] args) {
		super(message);
		this.args = args;
	}
