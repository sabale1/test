...
public class PaymentAdviceUpdateException extends RuntimeException {
...
private Object[] args; 
	...
	public PaymentAdviceUpdateException() {
		super();
	}
	
	public PaymentAdviceUpdateException(String message) {
		super(message);
	}
	
	public PaymentAdviceUpdateException(String message, Object[] args) {
		super(message);
		this.args = args;
	}
