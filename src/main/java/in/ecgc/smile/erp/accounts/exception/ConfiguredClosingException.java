...
public class ConfiguredClosingException extends RuntimeException {
...
private Object[] args; 
	...
	public ConfiguredClosingException() {
		super();
	}
	
	public ConfiguredClosingException(String message) {
		super(message);
	}
	
	public ConfiguredClosingException(String message, Object[] args) {
		super(message);
		this.args = args;
	}
