...
public class RegularOpeningException extends RuntimeException {
...
private Object[] args; 
	...
	public RegularOpeningException() {
		super();
	}
	
	public RegularOpeningException(String message) {
		super(message);
	}
	
	public RegularOpeningException(String message, Object[] args) {
		super(message);
		this.args = args;
	}
