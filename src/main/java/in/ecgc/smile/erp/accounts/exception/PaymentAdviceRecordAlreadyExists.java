...
public class PaymentAdviceRecordAlreadyExists extends RuntimeException {
...
private Object[] args; 
	...
	public PaymentAdviceRecordAlreadyExists() {
		super();
	}
	
	public PaymentAdviceRecordAlreadyExists(String message) {
		super(message);
	}
	
	public PaymentAdviceRecordAlreadyExists(String message, Object[] args) {
		super(message);
		this.args = args;
	}
