...
public class CalendarRecordNotFoundException extends RuntimeException {
...
private Object[] args; 
	...
	public CalendarRecordNotFoundException() {
		super();
	}
	
	public CalendarRecordNotFoundException(String message) {
		super(message);
	}
	
	public CalendarRecordNotFoundException(String message, Object[] args) {
		super(message);
		this.args = args;
	}
