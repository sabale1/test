...
public class PaymentAdviceValidationException extends RuntimeException {
...
private Object[] args; 
	...
	public PaymentAdviceValidationException() {
		super();
	}
	
	public PaymentAdviceValidationException(String message) {
		super(message);
	}
	
	public PaymentAdviceValidationException(String message, Object[] args) {
		super(message);
		this.args = args;
	}
